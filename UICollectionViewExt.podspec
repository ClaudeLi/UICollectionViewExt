...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UICollectionViewExt.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/claudeli@yeah.net/UICollectionViewExt'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'claudeli@yeah.net' => 'claudeli@yeah.net' }
  s.source           = { :git => 'https://github.com/claudeli@yeah.net/UICollectionViewExt.git', :tag => s.version.to_s }
