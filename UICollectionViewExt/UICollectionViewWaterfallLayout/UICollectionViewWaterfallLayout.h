 ...
 */
typedef NS_ENUM (NSUInteger, UICollectionViewWaterfallLayoutItemRenderDirection) {
  UICollectionViewWaterfallLayoutItemRenderDirectionShortestFirst,
  UICollectionViewWaterfallLayoutItemRenderDirectionLeftToRight,
  UICollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
};
...
/**
 *  The UICollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  UICollectionViewWaterfallLayout object to implement a waterfall-based layout.
...
#pragma mark - UICollectionViewWaterfallLayout

/**
 *  The UICollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `UICollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note UICollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (UICollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (UICollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (UICollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: UICollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) UICollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
